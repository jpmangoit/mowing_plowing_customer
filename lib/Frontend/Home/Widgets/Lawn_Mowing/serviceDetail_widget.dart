...
class _ServiceDetailState extends State<ServiceDetail> {
  ...
  Future summary() async {
    ...
    List? images = [];
    var image0 = localStorage.getString('image0L');
    var image1 = localStorage.getString('image1L');
    var image2 = localStorage.getString('image2L');
    var image3 = localStorage.getString('image3L');
    images.add(image0 ?? image0);
    images.add(image1 ?? image1);
    images.add(image2 ?? image2);
    images.add(image3 ?? image3);
    size = localStorage.getString('sizeL');
    height = localStorage.getString('heightL');
    var response = await BaseClient().orderSummary(
      "/order-summary",
      "1",
      localStorage.getString('orderAddress')!,
      localStorage.getString('orderLat')!,
      localStorage.getString('orderLng')!,
      localStorage.getString('sizeIdL')!,
      localStorage.getString('heightIdL')!,
      localStorage.getBool('fenceL')! ? localStorage.getBool('fenceL') : null,
      localStorage.getBool('fenceL')!
          ? localStorage.getString('fenceIdL')
          : null,
      localStorage.getBool('sevenDaysL')!
          ? "seven_days_price"
          : localStorage.getBool('tenDaysL')!
              ? "ten_days_price"
              : localStorage.getBool('fourteenDaysL')!
                  ? "fourteen_days_price"
                  : "price",
      localStorage.getBool('sevenDaysL')!
          ? "1"
          : localStorage.getBool('tenDaysL')!
              ...
              : localStorage.getBool('fourteenDaysL')!
                  ? "47"
                  : null,
      localStorage.getBool('yardBeforeMowL')!
          ? localStorage.getBool('yardBeforeMowL')
          : null,
      localStorage.getBool('yardBeforeMowL')!
          ? localStorage.getString('cleanUpIdL')
          : null,
      localStorage.getBool('cornerLotL')!
          ? localStorage.getBool('cornerLotL')
          : null,
      localStorage.getBool('sameDayL')! ? "Today" : null,
      localStorage.getBool('sameDayL')!
          ? null
          : localStorage.getString('dateControllerL'),
      localStorage.getString('gateCodeL'),
      localStorage.getString('instructionL'),
      images,
    );
    if (response["message"] == "Unauthenticated.") {
      ...
      if (response["success"]) {
        ...
        serviceDay = data["date"];
        onDemandFees = data["on_demand_fee"] ?? 0;
        sizeAmount = data["lawn_size_amount"];
        heightAmount = data["lawn_height_amount"];
        cornerLotAmount = data["corner_lot_amount"] ?? 0;
        tipPercentage = data["tip_perc"] ?? 0;
        tipAmount = data["tip"] ?? 0;
        discountAmount = data["discount_amount"] ?? 0;
        cleanUpAmount = data["cleanup_amount"] ?? 0;
                                  ...
                                  Material(
                                    ...
                                    child: DropdownButtonFormField(
                                      ...
                                      onChanged: (newValue) async {
                                        ...
                                        initialPercVal != 'Enter tip amount'
                                            ? localStorage
                                                        .getBool('oneTimeL') ==
                                                    true
                                                ? recurrTipVisibilty = false
                                                : recurrTipVisibilty = true
                                            : initialPercVal =
                                                'Enter tip amount';

                                        if (initialPercVal.contains(
                                            tenPerc.toStringAsFixed(2))) {
                                          tip = tenPerc.toStringAsFixed(2);
                                          tipPerc = "10";
                                        } else if (initialPercVal.contains(
                                            fifteenPerc.toStringAsFixed(2))) {
                                          tip = fifteenPerc.toStringAsFixed(2);
                                          tipPerc = "15";
                                        } else if (initialPercVal.contains(
                                            twentyPerc.toStringAsFixed(2))) {
