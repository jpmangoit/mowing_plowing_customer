...
class _ScheduleHomeState extends State<ScheduleHome> {
  ...
  Future schedules() async {
    ...
    var decode = localStorage.getString('snowPlowingSchedulesH');
    var decodeColor = localStorage.getString('snowPlowingScheduleSelectedH');
