...
class _ServiceSummaryState extends State<ServiceSummary> {
  ...
  Future summary() async {
    ...
    List? images = [];
    var image0 = localStorage.getString('image0C');
    var image1 = localStorage.getString('image1C');
    var image2 = localStorage.getString('image2C');
    var image3 = localStorage.getString('image3C');
    images.add(image0 ?? image0);
    images.add(image1 ?? image1);
    images.add(image2 ?? image2);
    images.add(image3 ?? image3);
    var decode =
        jsonDecode(localStorage.getString('snowPlowingScheduleSelectedC')!);
    scheduleTime = decode["name"];
    var response = await BaseClient().orderSummaryCar(
      "/get-order-summary",
      ...
      "2",
      "Car",
      jsonDecode(localStorage.getString('carSelectedC')!)["id"].toString(),
      localStorage.getString('currentColorIdC')!,
      localStorage.getString('carPlateNoC')!,
      localStorage.getString('instructionC')!,
      jsonDecode(localStorage.getString('snowPlowingScheduleSelectedC')!)["id"]
          .toString(),
      images,
    );
