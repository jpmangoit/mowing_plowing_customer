...
class ScheduleBusiness extends StatefulWidget {
  const ScheduleBusiness({super.key});

  @override
  State<ScheduleBusiness> createState() => _ScheduleBusinessState();
}

class _ScheduleBusinessState extends State<ScheduleBusiness> {
  ...
  Future schedules() async {
    ...
    var decode = localStorage.getString('snowPlowingSchedulesB');
    var decodeColor = localStorage.getString('snowPlowingScheduleSelectedB');
